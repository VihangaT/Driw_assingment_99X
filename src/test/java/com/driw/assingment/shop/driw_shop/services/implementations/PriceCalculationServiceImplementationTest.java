...
class PriceCalculationServiceImplementationTest{
    ...
    private PriceCalculationServiceImplementation priceCalculationServiceImplementation;

    @Autowired
    public PriceCalculationServiceImplementationTest(ProductRepository productRepository,PriceCalculationServiceImplementation priceCalculationServiceImplementation){
        this.productRepository=productRepository;
        this.priceCalculationServiceImplementation=priceCalculationServiceImplementation;
    }
